...
class soap_fault extends nusoap_base
{
    ...
    */
    public function soap_fault($faultcode, $faultactor='', $faultstring='', $faultdetail='')
    {
        parent::nusoap_base();
...
class XMLSchema extends nusoap_base
{
    ...
    * @access   public
    */
    public function XMLSchema($schema='', $xml='', $namespaces=array())
    {
        parent::nusoap_base();
...
class wsdl extends nusoap_base
{
     ...
     * @access public
     */
    public function wsdl($wsdl = '', $proxyhost=false, $proxyport=false, $proxyusername=false, $proxypassword=false, $timeout=0, $response_timeout=30)
    {
        parent::nusoap_base();
        $this->wsdl = $wsdl;
...
class soapclient2 extends nusoap_base
{
    ...
    * @access   public
    */
    public function soapclient2($endpoint, $wsdl = false, $proxyhost = false, $proxyport = false, $proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30)
    {
        parent::nusoap_base();
