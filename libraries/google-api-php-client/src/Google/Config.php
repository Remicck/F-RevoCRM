...
class Google_Config
{
    public const GZIP_DISABLED = true;
    public const GZIP_ENABLED = false;
    public const GZIP_UPLOADS_ENABLED = true;
    public const GZIP_UPLOADS_DISABLED = false;
    public const USE_AUTO_IO_SELECTION = "auto";
