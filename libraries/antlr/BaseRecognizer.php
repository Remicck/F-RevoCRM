...
abstract class BaseRecognizer
{
    ...
    protected function mismatch($input, $ttype, $follow)
    {
        ...
        } elseif ($this->mismatchIsMissingToken($input, $follow)) {
    ...
    public function getErrorMessage($e, $tokenNames)
    {
        ...
        if ($e instanceof UnwantedTokenException) {
            ...
            $msg = "extraneous input ".$this->getTokenErrorDisplay($ute->getUnexpectedToken()).
                " expecting ".$tokenName;
        } elseif ($e instanceof MissingTokenException) {
            $mte = $e;
            $tokenName="<unknown>";
        ...
        } elseif ($e instanceof MismatchedTokenException) {
            $mte = $e;
            $tokenName="<unknown>";
            if ($mte->expecting== TokenConst::$EOF) {
                $tokenName = "EOF";
            ...
            $msg = "mismatched input ".$this->getTokenErrorDisplay($e->token).
                " expecting ".$tokenName;
        } elseif ($e instanceof MismatchedTreeNodeException) {
            $mtne = $e;
            $tokenName="<unknown>";
            ...
            $msg = "mismatched tree node: ".$mtne->node.
                " expecting ".$tokenName;
        } elseif ($e instanceof NoViableAltException) {
            $nvae = $e;
            // for development, can add "decision=<<"+nvae.grammarDecisionDescription+">>"
            // and "(decision="+nvae.decisionNumber+") and
            // "state "+nvae.stateNumber
            $msg = "no viable alternative at input ".$this->getTokenErrorDisplay($e->token);
        } elseif ($e instanceof EarlyExitException) {
            $eee = $e;
            // for development, can add "(decision="+eee.decisionNumber+")"
            $msg = "required (...)+ loop did not match anything at input ".
                getTokenErrorDisplay($e->token);
        } elseif ($e instanceof MismatchedSetException) {
            $mse = $e;
            $msg = "mismatched input ".$this->getTokenErrorDisplay($e->token).
                " expecting set ".$mse->expecting;
        } elseif ($e instanceof MismatchedNotSetException) {
            $mse = $e;
            $msg = "mismatched input ".$this->getTokenErrorDisplay($e->token).
                " expecting set ".$mse->expecting;
     ...
     */
    public static function getRuleInvocationStack(
        $e=null,
