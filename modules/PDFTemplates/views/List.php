...
class PDFTemplates_List_View extends Vtiger_Index_View
{
    ...
    public function preProcess(Vtiger_Request $request, $display = true)
    {
        ...
        $listViewModel = PDFTemplates_ListView_Model::getInstance($moduleName);
    ...
    public function initializeListViewContents(Vtiger_Request $request, Vtiger_Viewer $viewer)
    {
        ...
        $listViewModel = PDFTemplates_ListView_Model::getInstance($moduleName, $cvId);
    ...
    public function getHeaderScripts(Vtiger_Request $request)
    {
        ...
        $jsFileNames = array(
                    ...
                    'modules.PDFTemplates.resources.List',
