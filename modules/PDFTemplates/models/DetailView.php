...
class PDFTemplates_DetailView_Model extends Vtiger_DetailView_Model
{
    /**
    ...
    public function getDetailViewLinks($linkParams)
    {
        ...
        $deletelinkModel = array(
                ...
                'linkurl' => 'javascript:PDFTemplates_Detail_Js.deleteRecord("'.$recordModel->getDeleteUrl().'")',
                'linkicon' => ''
        );
    ...
    public static function getInstance($moduleName, $recordId)
    {
        ...
        $moduleModel = PDFTemplates_Module_Model::getInstance($moduleName);
        $recordModel = PDFTemplates_Record_Model::getInstanceById($recordId, $moduleName);
