...
{
    public $baseTable = 'vtiger_language_rules';
    public $baseIndex = 'id';
    public $listFields = array('id' => 'ID', 'modulename' => 'Module', 'before_string' => 'Before', 'after_string' => 'After', 'language' => 'Language',);
    public $nameFields = array('');
    public $name = 'LanguageConverter';
