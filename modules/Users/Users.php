...
class Users extends CRMEntity
{
    ...
    public $encodeFields = array("last_name", "first_name", "description");
    ...
    public $emailTemplate_defaultFields = array('last_name','first_name','title','department','phone_home','phone_mobile','signature','email1','email2','address_street','address_city','address_state','address_country','address_postalcode');
    ...
    {
        $query = "SELECT u1.last_name, u1.first_name from vtiger_users u1, vtiger_users u2 where u1.id = u2.reports_to_id AND u2.id = ? and u1.deleted=0";
                ...
                foreach ($blockInstance as $fieldInstance) {
                    ...
                    if ($fieldName == 'status') {
                        ...
                        foreach ($allUsers as $user) {
                            ...
                            $firstLastName = strtolower($user->get('last_name')." ".$user->get('first_name'));
