...
class Dailyreports extends CRMEntity
{
    ...
    public $table_name = 'vtiger_dailyreports';
    public $table_index= 'dailyreportsid';
     ...
     */
    public $customFieldTable = array('vtiger_dailyreportscf', 'dailyreportsid');

    /**
     * Mandatory for Saving, Include tables related to this module.
     */
    public $tab_name = array('vtiger_crmentity', 'vtiger_dailyreports', 'vtiger_dailyreportscf');
    ...
    public $list_link_field = 'DailyreportsName';
    ...
    public $popup_fields = array('DailyreportsName');

    // Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
    public $sortby_fields = array('reportsdate','reports_to_id');

    // For Alphabetical search
    public $def_basicsearch_col = 'DailyreportsName';

    // Column value to use on detail view record text display
    public $def_detailview_recname = 'DailyreportsName';

    // Required Information for enabling Import feature
    public $required_fields = array('dailyreporstname'=>1);

    // Callback function list during Importing
    public $special_functions = array('set_import_assigned_user');

    public $default_order_by = 'reportsdate';
    public $default_sort_order='ASC';
    // Used when enabling/disabling the mandatory fields for the module.
    // Refers to vtiger_field.fieldname values.
    public $mandatory_fields = array('createdtime', 'modifiedtime', 'DailyreportsName', 'reportsdate');
