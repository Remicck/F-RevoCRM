...
class Dailyreports_Detail_View extends Vtiger_Detail_View
{
    /**
    ...
    public function getActivities(Vtiger_Request $request)
    {
        ...
        if ($currentUserPriviligesModel->hasModulePermission($moduleModel->getId())) {
            ...
            $relatedActivities = $moduleModel->getCalendarActivitiesHistory(
                '',
                $pagingModel,
                $recordModel->get('assigned_user_id'),
                $recordModel->get('reportsterm'),
                $recordModel->get('ReportsDate')
            );
