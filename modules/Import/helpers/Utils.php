...
class Import_Utils_Helper
{
    ...
    public static $supportedFileEncoding = array('UTF-8'=>'UTF-8', 'CP932'=>'Shift-JIS(CP932)', 'ISO-8859-1'=>'ISO-8859-1');
    public static $supportedDelimiters = array(','=>'comma', ';'=>'semicolon', '|'=> 'Pipe', '^'=>'Caret');
