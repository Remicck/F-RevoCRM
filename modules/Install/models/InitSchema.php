...
class Install_InitSchema_Model
{
    ...
    public static function populateDefaultWorkflows($adb)
    {
        ...
        // $task->subject = "顧客企業登録のお知らせ";
        // $task->content = "F-RevoCRMに顧客企業が登録されました。<br>詳細は以下になります。<br><br>".
        // 		"顧客企業番号:".'<b>$account_no</b><br>'."顧客企業名:".'<b>$accountname</b><br>'.
        // 		"備考:".'<b>$詳細内容</b><br><br><br>'."※F-RevoCRMからの自動送信メールです。";
        // $task->summary="顧客企業登録のお知らせ";
        // $tm->saveTask($task);
        ...
        $task->content = "An Contact has been assigned to you on F-RevoCRM<br>Details of Contact are :<br><br>".
        ...
        // $task->content = "An Potential has been assigned to you on F-RevoCRM<br>Details of Potential are :<br><br>".
