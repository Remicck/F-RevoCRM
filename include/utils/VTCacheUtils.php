...
class VTCacheUtils
{
    ...
    public static function lookupFieldInfo($tabid, $fieldname)
    {
        ...
        } elseif (isset(self::$_fieldinfo_cache[$tabid]) && isset(self::$_fieldinfo_cache[$tabid][$fieldname])) {
    ...
    public static $lookupModuleFieldInfo = array();
    ...
    public static $_module_entityname_cache = array();
    ...
    public static function lookupEntityNameInfo($module)
    {
        ...
        if ($entityNames) {
            return $entityNames;
        } elseif (isset(self::$_module_entityname_cache[$module])) {
    ...
    /** Record Owner Id */
    public static $_record_ownerid_cache = array();
    ...
    /** Record Owner Type */
    public static $_record_ownertype_cache = array();
    ...
    public static $_userSignature = array();
    ...
    public static $_userFullName = array();
    ...
    public static $_report_field_bylabel = array();
    ...
    /** Record group Id */
    public static $_record_groupid_cache = array();
