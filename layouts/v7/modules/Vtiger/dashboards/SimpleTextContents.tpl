...
<div class="simpleTextWidgetContainer">
	<div class="widget-contents">
		{if $WIDGET}
			...
			{if $WIDGET_DATA && $WIDGET_DATA.text}
				<div class="textDisplay" data-mode="display">
					{$WIDGET_DATA.text|escape:'html'}
				</div>
			{else}
				<div class="noContent">
			...
			<div class="editMode hide">
				<textarea class="form-control simpleTextEdit" rows="5" placeholder="{vtranslate('LBL_ENTER_TEXT', $MODULE_NAME)}">{if $WIDGET_DATA && $WIDGET_DATA.text}{$WIDGET_DATA.text|escape:'html'}{/if}</textarea>
